 ...
 function goStore(){
     ...
     if (monster === "wizard"){
         ...
         if (health <= 0){
             ...
             if (monster === "slime"){
                ...
                text.innerHTML = "Game over. The Wizard turned you into a slime. &#x2620"
             }
     }  
     if (weakened){
         ...
         if (dodgeRandomNumber > 0.5){
             ...
             if (health <= 0){
                 ...
                 if (monster === "slime"){
                    ...
                    text.innerHTML = "Game over. The Wizard turned you into a frog. &#x2620";
                 }
         }
         }
     }
    ...
    function win(){
        ...
        frozen = false;
         ...
         button2.innerText = "PLAY AGAIN?";
         button3.innerText = "PLAY AGAIN?";
         button1.onclick = restart;
         button2.onclick = restart;
         button3.onclick = restart;
         text.innerText = "You defeated the wizard! You Win!";
     }
